			...
			{fields.map((field) => (
				<div key={field.id} className="flex flex-col gap-2">
					...
					<input
						...
						className="border-2 border-gray-500 rounded-lg w-full py-2 px-4 focus:outline-none focus:ring-2  focus:border-transparent focus:border-blue-500 focus:ring-opacity-75"
					/>
				</div>
			))}
			<button
